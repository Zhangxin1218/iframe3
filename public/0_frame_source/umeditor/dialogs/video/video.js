...
(function(){
    ...
    UM.registerWidget( widgetName,{
        ...
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=video_url%>video.css\" />" +
            ...
            "<table><tr><td><label for=\"eduiVideoUrl\" class=\"edui-video-url\"><%=lang_video_url%></label></td><td><input id=\"eduiVideoUrl\" type=\"text\" style=\"width:370px;\"></td><td><a class=\"layui-btn layui-btn-sm um_choose_video_btn\">选择视频</a><input type=\"file\" class=\"um_choose_video\" style=\"display: none\" accept=\".mp4\"></td>\n</tr></table>" +
        ...
        initContent:function( editor, $widget ){
            ...
            $(me.$widget).delegate( ".um_choose_video_btn", "click", function ( e ) {
                $('.um_choose_video').click();
            });
            $(me.$widget).delegate( ".um_choose_video", "change", function ( e ) {
                var formData = new FormData();
                formData.append("file",this.files[0]);
                $.ajax({
                    url: me.editor.options.videoUrl, /*接口域名地址*/
                    type:'post',
                    data: formData,
                    contentType: false,
                    processData: false,
